...
{
  "$schema": "https://opencode.ai/config.json",
  "model": "poolside/laguna_m_preview",
  "provider": {
    "poolside": {
      "npm": "@ai-sdk/openai-compatible",
      "name": "Poolside",
      ...
      "models": {
        "poolside/laguna_m_preview": {
          "name": "Laguna M (preview)"
        }
      }
    }
  }
...
- **models**: the model IDs your deployment exposes. Run `curl https://poolside.example.com/openai/v1/models` (with your key) to list them.
